...
app.use(
    helmet({
        contentSecurityPolicy:{
            ...
            directives:{
                "default-src":["'self'"],
                "script-src":["'self'","'unsafe-inline'","https://cdn.jsdelivr.net","https://cdnjs.cloudflare.com","https://api.mapbox.com","https://checkout.razorpay.com"],
                ...
                "connect-src":["'self'","https://api.mapbox.com","https://api.razorpay.com"],
